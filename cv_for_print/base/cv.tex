...
\begin{minipage}{0.25\textwidth}
    \begin{tikzpicture}
        ...
        % Place the image
        \node at (0, 0) {\includegraphics[height=6cm]{./assets/profile_pic_small.jpg}};
...
\begin{itemize}[noitemsep]
    \item Building web applications in Svelte/SvelteKit, leading UI/UX development.
    \item Designing APIs and databases for scalable systems.
