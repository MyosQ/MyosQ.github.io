<script lang="ts">
	...
	const CONFIG = {
		...
		colors: {
			trunk: new THREE.Color(0.08, 0.04, 0.02),
			branch: new THREE.Color(0.06, 0.03, 0.02),
			needleBase: new THREE.Color(0.002, 0.008, 0.002),
			needleTip: new THREE.Color(0.004, 0.015, 0.004)
		}
	} as const;
